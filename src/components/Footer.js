            ...
            <Grid container spacing={4}>
              <Grid item xs={12} md={4} lg={3}>
                ...
                <Typography className={classes.info}>
                  <Font index={1}>
                    Careetor, 81300 Johor Bahru, Johor, Malaysia
                  </Font>
                </Typography>

                <Typography className={classes.info}>
                  <Font index={1}>learn@careetor.app</Font>
                </Typography>
              </Grid>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={6} sm={4}>
                    <CategoryProvider useStyles={useMagCategoryMenuStyles}>
                      ...
                      <CategoryItem>
                        <Font index={1}>Careetor</Font>
                      </CategoryItem>
                      <CategoryItem>
                        <Font index={1}>Parents</Font>
                      </CategoryItem>
                      <CategoryItem>
                        <Font index={1}>Schools</Font>
                      </CategoryItem>
                      <CategoryItem>
                        <Font index={1}>Provider</Font>
                      </CategoryItem>
                    </CategoryProvider>
                  </Grid>
                  <Grid item xs={6} sm={4}>
            ...
            >
              ...
              <Item>
                <Box py={1} textAlign={{ xs: "center", md: "right" }}>
                  ...
                  >
                    <Font index={1}>
                      Designed by Jezrin Technoloiges 2020 All right reserved
                    </Font>
                  </Typography>
                </Box>
              </Item>
